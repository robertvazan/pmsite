 ...
 * instead of have two huge configuration files, one for production and one for development.
 ...
 * The downside that any code running too early will use the wrong configuration.
